...
class AudioPlayerRespiracaoThree extends StatefulWidget {
  const AudioPlayerRespiracaoThree({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerRespiracaoThree> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaotres/respiracaotres.mp3');
