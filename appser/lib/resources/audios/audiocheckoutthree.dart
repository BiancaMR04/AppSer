...
class AudioPlayerCheckoutThree extends StatefulWidget {
  const AudioPlayerCheckoutThree({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckoutThree> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaotres/checkouttres.mp3');
