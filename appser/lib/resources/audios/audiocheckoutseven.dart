...
class AudioPlayerCheckoutSeven extends StatefulWidget {
  const AudioPlayerCheckoutSeven({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckoutSeven> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaosete/checkoutsete.mp3');
