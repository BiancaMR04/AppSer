...
class AudioPlayerPararAudioSeven extends StatefulWidget {
  const AudioPlayerPararAudioSeven({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerPararAudioSeven> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaosete/pararaudiosete.mp3');
