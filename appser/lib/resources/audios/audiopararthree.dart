...
class AudioPlayerPararAudioThree extends StatefulWidget {
  const AudioPlayerPararAudioThree({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerPararAudioThree> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaotres/pararaudiotres.mp3');
