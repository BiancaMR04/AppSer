...
class AudioPlayerConsciencia extends StatefulWidget {
  const AudioPlayerConsciencia({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerConsciencia> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaoquatro/conscienciaquatro.mp3');
