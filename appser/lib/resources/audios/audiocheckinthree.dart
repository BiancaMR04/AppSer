...
class AudioPlayerCheckinThree extends StatefulWidget {
  const AudioPlayerCheckinThree({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckinThree> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaotres/checkintres.mp3');
