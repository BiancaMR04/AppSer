...
class AudioPlayerEscaneamOne extends StatefulWidget {
  const AudioPlayerEscaneamOne({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerEscaneamOne> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaoum/escaneamentoone.mp3');
