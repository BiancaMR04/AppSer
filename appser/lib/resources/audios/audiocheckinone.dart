...
class AudioPlayerCheckinOne extends StatefulWidget {
  const AudioPlayerCheckinOne({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckinOne> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaoum/checkinone.mp3');
