...
class AudioPlayerCheckinFour extends StatefulWidget {
  const AudioPlayerCheckinFour({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckinFour> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaoquatro/checkinquatro.mp3');
