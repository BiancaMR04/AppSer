...
class AudioPlayerCheckinSeven extends StatefulWidget {
  const AudioPlayerCheckinSeven({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckinSeven> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaosete/checkinsete.mp3');
