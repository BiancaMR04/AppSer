...
class AudioPlayerCheckinTwo extends StatefulWidget {
  const AudioPlayerCheckinTwo({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckinTwo> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaodois/checkintwo.mp3');
