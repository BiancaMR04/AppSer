...
class AudioPlayerPararAudioSix extends StatefulWidget {
  const AudioPlayerPararAudioSix({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerPararAudioSix> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaoseis/pararaudioseis.mp3');
