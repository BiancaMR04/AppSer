...
class AudioPlayerConscienciaThree extends StatefulWidget {
  const AudioPlayerConscienciaThree({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerConscienciaThree> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaotres/conscienciatres.mp3');
