...
class AudioPlayerMeditacao extends StatefulWidget {
  const AudioPlayerMeditacao({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerMeditacao> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaoquatro/meditacaosentadaquatro.mp3');
