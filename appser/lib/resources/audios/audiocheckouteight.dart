...
class AudioPlayerCheckoutEight extends StatefulWidget {
  const AudioPlayerCheckoutEight({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckoutEight> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaooito/checkouteight.mp3');
