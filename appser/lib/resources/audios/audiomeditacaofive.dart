...
class AudioPlayerMeditacaoFive extends StatefulWidget {
  const AudioPlayerMeditacaoFive({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerMeditacaoFive> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaocinco/meditacaosentadacinco.mp3');
