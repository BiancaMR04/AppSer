...
class AudioPlayerPraticaPensamento extends StatefulWidget {
  const AudioPlayerPraticaPensamento({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerPraticaPensamento> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaoseis/praticadospenseis.mp3');
