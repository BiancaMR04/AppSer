...
class AudioPlayerCheckoutFour extends StatefulWidget {
  const AudioPlayerCheckoutFour({super.key});

  @override
  _AudioPlayerScreenState createState() => _AudioPlayerScreenState();
}

class _AudioPlayerScreenState extends State<AudioPlayerCheckoutFour> {
...
Future<void> _loadAudio() async {
  try {
    Reference audioRef = FirebaseStorage.instance.ref().child('audios/sessaoquatro/checkoutquatro.mp3');
